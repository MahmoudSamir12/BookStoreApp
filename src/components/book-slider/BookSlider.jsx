...
const BookSlider = ({data}) => {
    ...
    const handleClick = (direction) => {
        if(direction === "left")
        {
            ...
            setSlideIndex((slideIndex) => (slideIndex >= 0 ? slideIndex - 1 : totalSlides - 1));
        }
        else{
            //setSlideIndex(slideIndex + 1);
            //setSlideIndex(slideIndex < totalSlides-1 ? slideIndex + 1 : 0 );
            setSlideIndex((slideIndex) => (slideIndex <= totalSlides - 1 ? slideIndex + 1 : 0));
        }
    }
    ...
    return (
        <div className='book-slider-container'>
            ...
            {/*slideIndex >= 0  && <i 
                ...
                className='bi bi-chevron-left  book-slider-arrow-left'></i>
            */}
